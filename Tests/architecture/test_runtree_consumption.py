...
_BASELINE: dict = {('Diagnostics/bucket_fill.py', 'warehouse.db'): 1,
 ...
 # ── the analysis package's own writers ──────────────────────────────────────────────
 # A writer naming the file it writes is the ratchet's sanctioned use (the same class the
 # retired suite/report-bars entries occupied).  The chart-family redesign re-baselined this
 # block on 2026-08-22 and it SHRANK: the figure modules spell no filenames at all now (the
 ...
 ('Optimization/Performance_Evaluations/aggregate/tables.py', 'by_initial_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/aggregate/tables.py', 'by_initial_tests.json'): 1,
 ('Optimization/Performance_Evaluations/aggregate/tables.py', 'tests.json'): 2,
 ...
 ('Optimization/Performance_Evaluations/config/series.py', 'series.json'): 3,
 ...
 ('Optimization/Performance_Evaluations/tables/per_run.py', 'batches_long.csv'): 1,
 ('Optimization/Performance_Evaluations/tables/per_run.py', 'per_run_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/tables/stats_csv.py', 'by_initial_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/tables/stats_csv.py', 'by_initial_tests.json'): 1,
 ('Optimization/Performance_Evaluations/tables/stats_csv.py', 'stats_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/tables/stats_csv.py', 'tests.json'): 2,
 ...
 ('docs/experiments/ingest.py', 'config.json'): 5,
 ...
 ('docs/experiments/ingest.py', 'whatif_delta.json'): 3,

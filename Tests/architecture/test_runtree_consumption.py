...
_BASELINE: dict = {('Diagnostics/bucket_fill.py', 'warehouse.db'): 1,
 ...
 ('Optimization/Performance_Evaluations/aggregate/stats.py', '_aggregate'): 6,
 ('Optimization/Performance_Evaluations/aggregate/stats.py', 'aggregate_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/aggregate/stats.py', 'aggregate_tests.json'): 1,
 ('Optimization/Performance_Evaluations/aggregate/stats.py', 'by_initial_summary.csv'): 2,
 ('Optimization/Performance_Evaluations/aggregate/stats.py', 'tests.json'): 1,
 ...
 ('Optimization/Performance_Evaluations/config/summary_csv.py', 'summary_batch.csv'): 2,
 ('Optimization/Performance_Evaluations/config/summary_csv.py', 'summary_task.csv'): 2,
 ('Optimization/Performance_Evaluations/compare/throughput_vs_labor.py', 'series.json'): 1,
 ...
 ('Optimization/Performance_Evaluations/stats/suite.py', 'by_initial_summary.csv'): 3,
 ('Optimization/Performance_Evaluations/stats/suite.py', 'stats_summary.csv'): 1,
 ('Optimization/Performance_Evaluations/stats/suite.py', 'tests.json'): 1,

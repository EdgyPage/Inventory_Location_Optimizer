...
_LITERALS = {
    ...
    'compare.throughput_vs_labor':       ('compare',),
    'compare.delta_vs_baseline':             ('compare', 'breakdown'),
    'compare.labor_per_batch':            ('compare', 'breakdown'),
    'compare.pick_vs_travel':         ('compare', 'breakdown'),
    'compare.task_duration_by_strategy':               ('compare', 'breakdown'),
    'compare.task_time_breakdown':      ('compare', 'breakdown'),

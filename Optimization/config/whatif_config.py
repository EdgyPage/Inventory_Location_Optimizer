...
SPECS = {
    ...
    '_inbound_perf_400k': {
        ...
        'inbound': phase2_inbound_axis(keep=('fifo', 'gmyopic')),
        'unpinned': 'a performance probe compares CODE, not rankings: runs A and B bind the same reference catalogue and flags, and the campaign pin refuses the current derivation (it moved after phase 1)',
        'reference': 'k1_off_fifo',
        'run_defaults': PHASE2_RUN_DEFAULTS,
    },

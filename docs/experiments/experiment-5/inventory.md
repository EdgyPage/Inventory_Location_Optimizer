...
[Experiment 4](../experiment-4/inventory.md)**, frozen once and replayed across both scheduler cells
so the inventory never varies. Tables and plots are generated from the committed `params.json` /
...
<figure markdown>
  ...
  <figcaption>Realised demand mass (frequency × quantity) per category.</figcaption>
</figure>

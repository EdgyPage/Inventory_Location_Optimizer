...
arch-synced-commit: ca24eb345662942fa2b63ef22303d727c5b9f6e6  <!-- updated by the architecture-maintainer agent after each sync (context/arch/ + architecture.yml + files.yml + docs/architecture/) -->

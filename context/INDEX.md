...
arch-synced-commit: 1b3092f239d3f14517d712c437eb4cbf291b040b  <!-- updated by the architecture-maintainer agent after each sync (context/arch/ + architecture.yml + files.yml + docs/architecture/) -->
